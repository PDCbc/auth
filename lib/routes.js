                                    ...
                                    case 401: //failed login
                                        ...
                                        res.format({
                                            ...
                                            json: function () {
                                                ...
                                                res.json({
                                                    cookie : null,
                                                    message: "Invalid credentials provided, login failed."
                                                });
                                                return;
                                    ...
                                    case 400: //invalid data format
                                        ...
                                        res.format({
                                            ...
                                            json: function () {
                                                ...
                                                res.json({
                                                    cookie : null,
                                                    message: "Malformed input to auth, login failed."
                                                });
                                                return;
                                    ...
                                    case 500:
                                        ...
                                        res.format({
                                            ...
                                            json: function () {
                                                ...
                                                res.json({
                                                    cookie : null,
                                                    message: "Server caused an error during authentication, check logs for details."
                                                });
                                                return;
                                    ...
                                    default:
                                        ...
                                        res.format({
                                            ...
                                            json: function () {
                                                ...
                                                res.json({
                                                    cookie : null,
                                                    message: "Unknown error during login, check logs for details."
                                                });
                                                return;
